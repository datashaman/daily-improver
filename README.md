...
3. `test` enforces three stable intent-specific baseline executions and seals generated regression, characterization, measurement, and quality tests plus `test-plan/v7` and `generated-test-lifecycle-decision/v1`; detected Pest or PHPUnit work also seals its exact framework-specific generated-test quality inspection, property work additionally seals its validated `property-test-execution-proof/v1` and `test-implementation-inspection/v1` artifacts, and applicable known-mutant work seals `known-mutation-execution-proof/v1`.
