...
3. `test` enforces the intent-specific baseline proof and seals generated regression, characterization, measurement, and quality tests plus `test-plan/v3`; property work additionally seals its validated `property-test-execution-proof/v1` artifact.
