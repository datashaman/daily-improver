...
3. `test` enforces the intent-specific baseline proof and seals generated regression, characterization, measurement, quality, and property tests plus `test-plan/v2` in an HMAC manifest.
