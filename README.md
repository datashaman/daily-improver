...
3. `test` enforces the intent-specific baseline proof and seals generated regression, characterization, measurement, and quality tests plus `test-plan/v5`; property work additionally seals its validated `property-test-execution-proof/v1` and `test-implementation-inspection/v1` artifacts, and applicable known-mutant work seals `known-mutation-execution-proof/v1`.
